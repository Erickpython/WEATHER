...
def download_gfs_kenya(date_str, output_path, cycle='00', forecast_hours=range(0, 25, 3)):
    """
    Downloads GFS data for the Kenya bounding box.
    """
    base_url = 'https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25.pl'

    # Kenya bounding box
    toplat, bottomlat = 8, -8
    leftlon, rightlon = 30, 45
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download GFS data for Kenya WRF runs.")
    ...
    success = download_gfs_kenya(date_str=args.date, output_path=args.outdir)
